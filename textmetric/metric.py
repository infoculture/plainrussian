...
#    adapt_algorithm_3r(calc_Flesh_Kincaid_Grade_rus_adapted, ['n_syllabes', 'n_words', 'n_sentences'], ranges=[[0.3, 0.4, 0.001], [10, 20, 0.1], [30, 40, 0.05]], expected_max=0, expected_mean=0)
